...
function myReplace(str, before, after) {
    ...
    if(strSplit[i] == before && before[0] == before[0].toUpperCase()){
    return str.replace(strSplit[i],after[0].toUpperCase() + after.slice(1))
    } else if(strSplit[i] == before && before[0] !== before[0].toUpperCase()){
    return str.replace(strSplit[i],after[0].toLowerCase() + after.slice(1))
    }
    return str;
  }
